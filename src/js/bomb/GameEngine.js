GameEngine = Class.extend({
    ...
    load: function() {
        ...
        queue.loadManifest([
            {id: "playerBoy", src: "src/img/bomb/george.png"},
            {id: "playerGirl", src: "src/img/bomb/betty.png"},
            {id: "playerGirl2", src: "src/img/bomb/betty2.png"},
            {id: "tile_grass", src: "src/img/bomb/tile_grass.png"},
            {id: "tile_wall", src: "src/img/bomb/tile_wall.png"},
            {id: "tile_wood", src: "src/img/bomb/tile_wood.png"},
            {id: "bomb", src: "src/img/bomb/bomb.png"},
            {id: "fire", src: "src/img/bomb/fire.png"},
            {id: "bonuses", src: "src/img/bomb/bonuses.png"}
        ]);
