Menu = Class.extend({
    ...
    draw: function(text) {
        ...
        var singleIcon = new createjs.Bitmap("src/img/bomb/betty.png");
        ...
        var multiIconGirl = new createjs.Bitmap("src/img/bomb/betty.png");
        ...
        var multiIconBoy = new createjs.Bitmap("src/img/bomb/betty2.png");
